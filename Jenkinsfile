pipeline {
  ...
  stages {
    ...
    stage('Deploy') {
      steps {
        script {
          ansiblePlaybook credentialsId: 'digitalBookingDeployment', disableHostKeyChecking: true, installation: 'ansible', playbook: 'digitalBookingPlaybook.yaml', sudo: true
        }
