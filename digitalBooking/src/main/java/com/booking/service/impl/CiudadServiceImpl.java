...
public class CiudadServiceImpl implements ICiudadService {
    ...
    @Override
    public Ciudad insert(Ciudad ciudad) throws InvalidDataException,ResourcesNotFoundException {

        if(ciudad.getPais() == null || ciudad.getNombre() == null || ciudad.getPais().trim() == "" || ciudad.getNombre().trim() == "")
           throw new ResourcesNotFoundException("el dato de pais o nombre de la ciudad se encuentra vacio");
